      ...
      body: Column(
        children: <Widget>[
          ...
          RaisedButton(
            ...
            onPressed: () {
              debugPrint('olha clicou no confirmar');
              ...
              if (numeroConta!=null && valor!=null) {
                ...
                debugPrint('$transferecniaCriada' );
              }
            },
          ),
        ],
...
class ListaTransferencia extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Transferëncias'),
      ),
      body: Column(
        children: <Widget>[
        ItemTransferencia(Transferencia(100, 1001)),
        ItemTransferencia(Transferencia(200, 10002)),
